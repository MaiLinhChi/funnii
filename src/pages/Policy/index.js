    ...
    return (
        <div className="CompanyPage block">
            ...
            <div className="PrivacyPolicy-content style-content">
                <p>The app as a Freemium app. This SERVICE is provided by at no cost and is intended for use as is.</p>
                ...
                <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                    accessible at the app unless otherwise defined in this Privacy Policy.</p>
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Information Collection and Use</p>
                <p>For a better experience, while using our Service, I may require you to provide us with certain
                    personally identifiable information, including but not limited to contact@funnii.net . The
                ...
                <ul>
                    <li><a href="https://play.google.com/intl/en_US/about/play-terms/">Google Play Services</a></li>
                </ul>
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Log Data</p>
                ...
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Service Providers</p>
                ...
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Links to Other Sites</p>
                ...
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Children’s Privacy</p>
                ...
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Changes to This Privacy Policy</p>
                ...
                <p style={{    fontWeight: 700,
                    fontSize: '1.5rem',
                    marginBottom: '2rem'}}>Contact Us</p>
